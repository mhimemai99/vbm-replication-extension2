...
**Table 1. Characteristics of Included fMRI Studies**
...
*Abbreviations: ACC, anterior cingulate cortex; PCC, posterior cingulate cortex; MFG, middle frontal gyrus; DMN, default mode network; IFG, inferior frontal gyrus; STG, superior temporal gyrus*
...
**Table 2. Characteristics of Included sMRI Studies**

| Study | Country | N | Method | Brain Regions (direction) |
|-------|---------|---|--------|---------------------------|
| Tregellas et al. (2007) | USA | 64 | VBM | PFC (↑), STG (↑) |
| Van Haren et al. (2010) | Netherlands | 209 | Automated | Progressive loss |
| Schneider et al. (2014) | Germany | 189 | FreeSurfer | DLPFC (↓), hippocampus (↓) |
| Jørgensen et al. (2015) | Norway | 743 | FreeSurfer | ACC (↓), insula (↓) |
| Yokoyama et al. (2018) | Japan | 100 | VBM | Left PFC (↓) |
| Ringin et al. (2022) | Australia | 534 | FreeSurfer | Diagnosis × smoking |
| Qiu et al. (2024) | USA | Multi-site | Multimodal | Hippocampus, ACC, insula |
| Musket et al. (2026) | USA | 506 | FreeSurfer | Hippocampus |

The hippocampus showed consistent reductions in smokers with schizophrenia across multiple studies. Schneider et al. (2014) reported approximately 2.2% lower hippocampal volume in smokers compared to non-smokers with schizophrenia, and this finding was supported by Qiu et al. (2024) and Musket et al. (2026). The anterior cingulate cortex showed reduced thickness in smokers (Jørgensen et al., 2015; Qiu et al., 2024), as did the insula (Jørgensen et al., 2015; Qiu et al., 2024). Findings for the prefrontal cortex were mixed: Tregellas et al. (2007) reported increased gray matter in smokers, whereas later studies with larger samples found reductions (Schneider et al., 2014; Yokoyama et al., 2018).

Five of eight studies (63%) reported interactions between diagnostic status and smoking on brain structure, suggesting that smoking may affect brain structure differently in individuals with schizophrenia compared to healthy populations. Van Haren et al. (2010), the only longitudinal study, found that heavy smoking was associated with accelerated gray matter loss over time.
...
**Table 3. Brain Regions Across fMRI and sMRI Literatures**

| Brain Region | fMRI Studies | sMRI Studies |
|--------------|--------------|--------------|
| ACC | Smallwood; Aytur | Jørgensen; Qiu |
| Insula | Smallwood; Lee | Jørgensen; Qiu |

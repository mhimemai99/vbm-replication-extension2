...
\begin{table}[htbp]
\centering
\caption{Characteristics of Included fMRI Studies on Psychological Flexibility}
\label{tab:fmri}
\small
\begin{tabular}{p{2.5cm}p{3cm}p{2.5cm}p{1.5cm}p{4.5cm}}
\toprule
Study & Sample & Design & PF Measure & Key Neural Findings \\
\midrule
Smallwood et al. (2016) & 16 ACT, 9 control; opioid addiction + chronic pain & RCT: 8-week ACT vs. health education & ACT intervention & Post-ACT: $\downarrow$ ACC, insula, PCC, MFG activation during pain anticipation \\
Aytur et al. (2021) & 9 women; chronic pain & Pre-post: 4-week ACT & AAQ-II, CPAQ & Post-ACT: $\downarrow$ DMN, salience, frontoparietal connectivity; ACC correlated with AAQ-II \\
Lee et al. (2023) & 21 ACT, 21 waitlist; OCD & RCT: 8-week ACT vs. waitlist & AAQ-OC, CFQ & Post-ACT: $\uparrow$ insula activation, $\uparrow$ insula-IFG connectivity; insula correlated with PF ($\rho = -0.35$) \\
Cho et al. (2025) & 42 healthy adults & Cross-sectional & AAQ-II & Higher PF: stronger DMN-DAN anticorrelation \\
\bottomrule
\end{tabular}

\vspace{0.5em}
\footnotesize\textit{Note}: PF = psychological flexibility; ACT = Acceptance and Commitment Therapy; $\uparrow$ = increased post-ACT or with higher PF; $\downarrow$ = decreased post-ACT or with higher PF.
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Characteristics of Included sMRI Studies on Smoking in Schizophrenia}
\label{tab:smri}
\small
\begin{tabular}{p{2.5cm}p{3.5cm}p{1.8cm}p{2cm}p{4cm}}
\toprule
Study & Sample & Method & Regions & Key Findings (Smokers vs Non-Smokers) \\
\midrule
Tregellas et al. (2007) & 32 SCZ smokers, 32 SCZ non-smokers & VBM & Whole brain & $\uparrow$ GM: medial frontal gyrus, STG \\
Van Haren et al. (2010) & 159 SCZ, 50 HC; 5-year follow-up & Automated & Whole brain & Heavy smokers: accelerated GM loss in frontal, temporal, parietal \\
Schneider et al. (2014) & 54 SCZ smokers, 135 SCZ non-smokers & FreeSurfer & CT, subcortical & $\downarrow$ DLPFC thickness, $\downarrow$ hippocampus (2.2\%), $\downarrow$ amygdala \\
J{\o}rgensen et al. (2015) & 523 SCZ/BD smokers, 220 non-smokers & FreeSurfer & CT & $\downarrow$ ACC, $\downarrow$ insula, $\downarrow$ lateral OFC \\
Yokoyama et al. (2018) & 48 SCZ smokers, 52 SCZ non-smokers & VBM & Whole brain & $\downarrow$ left middle frontal gyrus, $\downarrow$ left precentral gyrus \\
Ringin et al. (2022) & 269 SCZ smokers, 265 SCZ non-smokers & FreeSurfer & Subcortical & No main effect; diagnosis $\times$ smoking interaction for thalamus, pallidum \\
Qiu et al. (2024) & Multi-site: 1,262 SCZ total & VBM, CT & Whole brain & $\downarrow$ hippocampus, $\downarrow$ ACC, $\downarrow$ insula, $\downarrow$ temporal cortex \\
Musket et al. (2026) & 253 SCZ smokers, 253 SCZ non-smokers & FreeSurfer & Hippocampus & $\downarrow$ hippocampus; dose-response with pack-years \\
\bottomrule
\end{tabular}

\vspace{0.5em}
\footnotesize\textit{Note}: SCZ = schizophrenia; HC = healthy controls; BD = bipolar disorder; GM = gray matter; CT = cortical thickness; $\uparrow$ = increased in smokers; $\downarrow$ = reduced in smokers.
\end{table}

The hippocampus emerged as the most consistently implicated region, with reductions in smokers reported by \citet{schneider2014} (2.2\% volume reduction), \citet{qiu2024}, and \citet{musket2026}. \citet{musket2026} further demonstrated a dose-response relationship, with greater hippocampal volume reduction associated with higher pack-years of smoking. The anterior cingulate cortex showed reduced thickness in smokers in two large studies \citep[N = 743]{jorgensen2015} and \citep[N = 1,262]{qiu2024}. The insula similarly showed reduced thickness in smokers \citep{jorgensen2015, qiu2024}.

Findings for the prefrontal cortex were mixed and may depend on the specific subregion examined. \citet{tregellas2007} reported increased gray matter volume in the medial frontal gyrus in smokers, whereas \citet{schneider2014} found reduced DLPFC thickness and \citet{yokoyama2018} found reduced left middle frontal gyrus volume. This discrepancy may reflect methodological differences (VBM vs. FreeSurfer), sample characteristics, or true regional heterogeneity within prefrontal cortex.

\citet{vanharen2010}, the only longitudinal study, found that heavy smoking was associated with accelerated gray matter loss over a 5-year follow-up period, suggesting smoking may contribute to progressive brain changes rather than reflecting only pre-existing differences. \citet{ringin2022} found no main effect of smoking on subcortical volumes but reported significant diagnosis $\times$ smoking interactions for thalamus and pallidum, indicating that smoking effects on these structures may differ between individuals with schizophrenia and healthy controls.
...
\begin{table}[htbp]
\centering
\caption{Comparison of Brain Regions Across fMRI (Psychological Flexibility) and sMRI (Smoking in Schizophrenia) Literatures}
\label{tab:overlap}
\small
\begin{tabular}{p{2.5cm}p{3.5cm}p{2cm}p{3.5cm}p{2cm}}
\toprule
Brain Region & fMRI: PF/ACT Studies & Direction & sMRI: Smoking in SCZ & Direction \\
\midrule
ACC & Smallwood; Aytur & $\downarrow$ post-ACT & J{\o}rgensen; Qiu & $\downarrow$ in smokers \\
Insula & Smallwood; Lee & Mixed & J{\o}rgensen; Qiu & $\downarrow$ in smokers \\
Prefrontal cortex & Smallwood; Lee & $\downarrow$ post-ACT & Tregellas; Schneider; Yokoyama & Mixed \\
PCC/DMN & Smallwood; Lee; Aytur; Cho & $\downarrow$ connectivity & --- & Not examined \\
Hippocampus & --- & Not examined & Schneider; Qiu; Musket & $\downarrow$ in smokers \\
Temporal cortex & Smallwood; Lee & Variable & Tregellas; Qiu & Mixed \\
\bottomrule
\end{tabular}

\vspace{0.5em}
\footnotesize\textit{Note}: Direction indicates predominant finding. Mixed = inconsistent findings across studies. PF = psychological flexibility; ACT = Acceptance and Commitment Therapy; SCZ = schizophrenia.
\end{table}
...
The anterior cingulate cortex supports conflict monitoring, error detection, and cognitive control \citep{botvinick2004}. \citet{smallwood2016} and \citet{aytur2021} reported decreased ACC activation and connectivity following ACT interventions, while \citet{jorgensen2015} and \citet{qiu2024} found reduced thickness in this region among smokers with schizophrenia. The convergent direction of findings (decreased activity post-ACT; reduced structure in smokers) raises questions about whether ACC integrity relates to flexibility-related processes, though this remains speculative without direct investigation.

The insula is implicated in interoception, craving awareness, and emotional processing \citep{craig2009, naqvibechara2010}. \citet{naqvi2007} demonstrated that damage to the insula can lead to spontaneous smoking cessation. However, fMRI findings for the insula were inconsistent: \citet{smallwood2016} found decreased insula activation following ACT, while \citet{lee2023} found increased activation and strengthened insula-IFG connectivity. Among smokers with schizophrenia, \citet{jorgensen2015} and \citet{qiu2024} consistently reported thinner insular cortex.

The prefrontal cortex supports executive function and value-based decision-making \citep{millercohen2001}. Findings in smokers with schizophrenia were mixed: \citet{schneider2014} found reduced DLPFC thickness and \citet{yokoyama2018} found reduced left middle frontal gyrus volume, while \citet{tregellas2007} found increased medial frontal gyrus volume. This discrepancy may reflect methodological differences (VBM vs. FreeSurfer) or true regional heterogeneity within prefrontal cortex. \citet{lee2023} found strengthened prefrontal connectivity following ACT.

The hippocampus warrants particular attention despite not appearing in the fMRI literature on psychological flexibility. It emerged as the most consistently implicated region in the sMRI literature, with reductions in smokers reported by three independent studies (\citealt{schneider2014}; \citealt{qiu2024}; \citealt{musket2026}). The hippocampus supports memory consolidation, contextual learning, and stress regulation---processes potentially relevant to both smoking behavior and psychological flexibility. The dose-response relationship between smoking and hippocampal volume \citep{musket2026} and longitudinal evidence of accelerated loss \citep{vanharen2010} suggest a causal relationship that future research on psychological flexibility should consider. No fMRI study has examined hippocampal function in relation to psychological flexibility, representing an unexplored area.

...
The present scoping review addresses four aims. First, building on Koster et al.'s foundation, we incorporate recently published studies (representing a 33% increase to the gray matter evidence base) to verify whether structural findings remain consistent. Second, we systematically review the functional neuroimaging literature examining psychological flexibility and ACT interventions in addiction contexts, identifying which brain regions show functional correlates of this construct. Third, we explicitly evaluate whether any structural MRI study of smoking in schizophrenia has measured psychological flexibility or related ACT constructs. Fourth, by comparing brain regions implicated in fMRI studies of psychological flexibility with those showing structural differences in smoking schizophrenia patients, we establish whether regional convergence supports investigating psychological flexibility as a mechanism linking brain structure to smoking behavior.

This scoping review is novel in its systematic bridging of two previously unconnected literatures: functional neuroimaging of psychological flexibility and structural neuroimaging of smoking in schizophrenia. By demonstrating regional overlap between these domains, we provide the empirical foundation for a primary study investigating brain structure, psychological flexibility, and smoking in schizophrenia.

---

## References (with verification links)

1. de Leon J, Diaz FJ (2005). A meta-analysis of worldwide studies demonstrates an association between schizophrenia and tobacco smoking behaviors. *Schizophrenia Research*, 76(2-3):135-157. PMID: 15949648. https://pubmed.ncbi.nlm.nih.gov/15949648/
...
*Draft version - revised with professional flowing style*
